      ...
      <div className="mt-12">
        <div className="flex items-center justify-between">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            />
            <div
              className="w-11 h-6 bg-silver-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-white-300
              rounded-full peer peer-checked:after:translate-x-full
              rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white-100 after:content-['']
              after:absolute after:top-[2px] after:start-[2px] after:bg-white-100 after:border-silver-300
